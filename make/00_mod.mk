...
build_names := manager validate_trust_package package_debian
...
go_validate_trust_package_main_dir := ./cmd/validate-trust-package
go_validate_trust_package_mod_dir := .
go_validate_trust_package_ldflags := 
oci_validate_trust_package_base_image_flavor := static
oci_validate_trust_package_image_name := <UNUSED>
oci_validate_trust_package_image_tag := <UNUSED>
oci_validate_trust_package_image_name_development := <UNUSED>
...
oci_package_debian_image_tag := <WILL REPLACE>
