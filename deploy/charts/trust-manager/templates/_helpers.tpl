...
Add the CA injection annotations automatically so the webhook configuration
can obtain its CA bundle from the TLS Secret regardless of whether the
certificate is managed by cert-manager or generated by Helm.
*/}}
