...
func newTestBundle(ctx context.Context, cl client.Client, opts options.BundleOptions, td TestData, targetType string) *trustapi.Bundle {
...
// Returns the create Bundle object.
func NewTestBundleSecretTarget(ctx context.Context, cl client.Client, opts options.BundleOptions, td TestData) *trustapi.Bundle {
...
// Returns the create Bundle object.
func NewTestBundleConfigMapTarget(ctx context.Context, cl client.Client, opts options.BundleOptions, td TestData) *trustapi.Bundle {
