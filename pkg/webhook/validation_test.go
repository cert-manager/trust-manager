	...
	tests := map[string]struct {
			...
			bundle: &trustapi.Bundle{
				Spec: trustapi.BundleSpec{
					Sources: []trustapi.BundleSource{
						{
							ConfigMap: &trustapi.SourceObjectKeySelector{Name: "test", SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}},
							InLine:    ptr.To("test"),
						},
						{InLine: ptr.To("test")},
						{
							ConfigMap: &trustapi.SourceObjectKeySelector{Name: "test", SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}},
							Secret:    &trustapi.SourceObjectKeySelector{Name: "test", SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}},
						},
					},
		...
		"sources names, selectors and keys are empty": {
			bundle: &trustapi.Bundle{
				Spec: trustapi.BundleSpec{
					Sources: []trustapi.BundleSource{
						{ConfigMap: &trustapi.SourceObjectKeySelector{Name: "", SourceKeySelector: trustapi.SourceKeySelector{Key: ""}}},
						{InLine: ptr.To("test")},
						{Secret: &trustapi.SourceObjectKeySelector{Name: "", SourceKeySelector: trustapi.SourceKeySelector{Key: ""}}},
					},
					Target: trustapi.BundleTarget{ConfigMap: &trustapi.KeySelector{Key: "test"}},
				},
			},
		...
		"sources names and selectors are both set": {
			bundle: &trustapi.Bundle{
				Spec: trustapi.BundleSpec{
					Sources: []trustapi.BundleSource{
						{ConfigMap: &trustapi.SourceObjectKeySelector{Name: "some-config-map", Selector: &metav1.LabelSelector{}, SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}}},
						{InLine: ptr.To("test")},
						{Secret: &trustapi.SourceObjectKeySelector{Name: "some-secret", Selector: &metav1.LabelSelector{}, SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}}},
					},
					Target: trustapi.BundleTarget{ConfigMap: &trustapi.KeySelector{Key: "test"}},
				},
			},
		...
		"sources defines the same configMap target": {
			bundle: &trustapi.Bundle{
				...
				Spec: trustapi.BundleSpec{
					Sources: []trustapi.BundleSource{
						{InLine: ptr.To("test")},
						{ConfigMap: &trustapi.SourceObjectKeySelector{Name: "test-bundle", SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}}},
					},
					Target: trustapi.BundleTarget{ConfigMap: &trustapi.KeySelector{Key: "test"}},
				},
			},
		...
		"sources defines the same secret target": {
			bundle: &trustapi.Bundle{
				...
				Spec: trustapi.BundleSpec{
					Sources: []trustapi.BundleSource{
						{InLine: ptr.To("test")},
						{Secret: &trustapi.SourceObjectKeySelector{Name: "test-bundle", SourceKeySelector: trustapi.SourceKeySelector{Key: "test"}}},
					},
