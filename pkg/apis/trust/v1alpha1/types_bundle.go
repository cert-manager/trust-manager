...
// +kubebuilder:deprecatedversion:warning="trust.cert-manager.io/v1alpha1 is deprecated, migrate to trust-manager.io/v1alpha2 ClusterBundle"
...
// Deprecated: This type will be removed in one of the next releases. Migrate to v1alpha2.ClusterBundleList instead.
