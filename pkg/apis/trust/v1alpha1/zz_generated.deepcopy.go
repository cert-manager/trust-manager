...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BundleLabelSelectorReference) DeepCopyInto(out *BundleLabelSelectorReference) {
	*out = *in
	if in.Selector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BundleLabelSelectorReference.
func (in *BundleLabelSelectorReference) DeepCopy() *BundleLabelSelectorReference {
	if in == nil {
		return nil
	}
	out := new(BundleLabelSelectorReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BundleSource) DeepCopyInto(out *BundleSource) {
	*out = *in
	...
	if in.ConfigMapLabelSelector != nil {
		in, out := &in.ConfigMapLabelSelector, &out.ConfigMapLabelSelector
		*out = new(BundleLabelSelectorReference)
		(*in).DeepCopyInto(*out)
	}
	if in.Secret != nil {
