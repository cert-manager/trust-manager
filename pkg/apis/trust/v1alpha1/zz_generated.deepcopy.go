...
func (in *JKS) DeepCopyInto(out *JKS) {
	*out = *in
	out.KeySelectorWithoutMetadata = in.KeySelectorWithoutMetadata
	if in.Password != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeySelectorWithoutMetadata) DeepCopyInto(out *KeySelectorWithoutMetadata) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeySelectorWithoutMetadata.
func (in *KeySelectorWithoutMetadata) DeepCopy() *KeySelectorWithoutMetadata {
	if in == nil {
		return nil
	}
	out := new(KeySelectorWithoutMetadata)
	in.DeepCopyInto(out)
	return out
}
