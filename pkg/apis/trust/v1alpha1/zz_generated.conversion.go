...
func autoConvert_v1alpha1_BundleTarget_To_v1alpha2_BundleTarget(in *BundleTarget, out *v1alpha2.BundleTarget, s conversion.Scope) error {
	// WARNING: in.ConfigMap requires manual conversion: inconvertible types (*github.com/cert-manager/trust-manager/pkg/apis/trust/v1alpha1.KeySelector vs github.com/cert-manager/trust-manager/pkg/apis/trustmanager/v1alpha2.KeyValueTarget)
	// WARNING: in.Secret requires manual conversion: inconvertible types (*github.com/cert-manager/trust-manager/pkg/apis/trust/v1alpha1.KeySelector vs github.com/cert-manager/trust-manager/pkg/apis/trustmanager/v1alpha2.KeyValueTarget)
...
func autoConvert_v1alpha2_BundleTarget_To_v1alpha1_BundleTarget(in *v1alpha2.BundleTarget, out *BundleTarget, s conversion.Scope) error {
	// WARNING: in.ConfigMap requires manual conversion: inconvertible types (github.com/cert-manager/trust-manager/pkg/apis/trustmanager/v1alpha2.KeyValueTarget vs *github.com/cert-manager/trust-manager/pkg/apis/trust/v1alpha1.KeySelector)
	// WARNING: in.Secret requires manual conversion: inconvertible types (github.com/cert-manager/trust-manager/pkg/apis/trustmanager/v1alpha2.KeyValueTarget vs *github.com/cert-manager/trust-manager/pkg/apis/trust/v1alpha1.KeySelector)
	out.NamespaceSelector = (*v1.LabelSelector)(unsafe.Pointer(in.NamespaceSelector))
	return nil
}
