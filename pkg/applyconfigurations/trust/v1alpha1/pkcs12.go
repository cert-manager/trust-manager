...
// PKCS12ApplyConfiguration represents an declarative configuration of the PKCS12 type for use
// with apply.
...
// PKCS12ApplyConfiguration constructs an declarative configuration of the PKCS12 type for use with
// apply.
